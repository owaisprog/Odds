...
import { featuredArticles } from "@/dummyData";
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12">
              <div className="max-w-3xl">
                {/* League Badge */}
                <div className="mb-4">
                  <span className="inline-block px-4 py-2 bg-[#B64E10] text-black text-xs font-bold rounded-full">
                    {featuredArticles[currentIndex].league}
                  </span>
                </div>
                ...
                <p className="text-md md:text-lg text-gray-200 font-inter mb-6 max-w-2xl">
                  {featuredArticles[currentIndex].subtitle}
                </p>

                {/* CTA Button */}
                <button className="inline-block px-5 py-1.5 bg-[#B64E10] hover:scale-105 text-black font-inter rounded-lg transition-colors duration-200">
                  Read Full Analysis
                </button>
              </div>
            </div>
